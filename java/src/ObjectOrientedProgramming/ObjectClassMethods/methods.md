## Клас `Object` є базовим класом для всіх класів в Java, тому він має ряд методів, які можна використовувати в усіх класах. Ось список всіх методів класу `Object`:
